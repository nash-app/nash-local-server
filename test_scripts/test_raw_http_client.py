                    ...
                    try:
                        ...
                        if "tool_calls" in data:
                            ...
                            for tool_call in data["tool_calls"]:
                                ...
                                if tool_call.get("id") and tool_call["id"] not in [t.get("id") for t in tool_calls if t.get("id")]:
                                    # New tool call
                                    tool_calls.append({
                                        "id": tool_call.get("id"),
                                        "function": {
                                    ...
                                    for t in tool_calls:
                                        if t.get("id") == tool_call.get("id") or (not tool_call.get("id") and t == tool_calls[-1]):
                                            # Append arguments
